...
export function PondManagementPage({ onNavigate }) {
  ...
  const handleEditPond = async (formData) => {
    try {
      setFormLoading(true);
      const result = await pondService.updatePond(editingPond.id, formData);
    ...
    <div className="min-h-screen bg-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <PondForm
          ...
          onSubmit={editingPond ? handleEditPond : handleCreatePond}

        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
          ...
          <Card>
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-muted-foreground text-sm">Baru (30 Hari)</p>
                  <p className="text-2xl font-bold text-foreground">{stats.recentRegistrations}</p>
                </div>
                    ...
                    <TableRow key={user.id}>
                      ...
                      <TableCell>
                        <div className="flex items-center gap-2">
                          ...
                          {userService.formatRegistrationDate(user.created_at)}
                        </div>
                      </TableCell>
                      <TableCell>
